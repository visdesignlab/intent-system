...
datasets = {
    ...
    'out_hard_training_1': Dataset.load_out_hard_training_1(),
    'out_med_training_1': Dataset.load_out_med_training_1(),
    ...
    'quad_easy_training_1': Dataset.load_quad_easy_training_1(),
